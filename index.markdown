...
<section class="w-full">
    <div class="h-64 mb-4 introduction">
        <div style="display: flex; justify-content: flex-start; margin-bottom: 1rem;">
            <img src="{{ '/assets/images/profile.jpg' | relative_url }}" alt="Emran Poh" style="width: 120px; height: 120px; border-radius: 0.5rem; object-fit: cover; border: 2px solid #f3f4f6;">
        </div>
        ...
        <p class="mobile-hello-text" style="font-size: 1rem; font-weight: 500;">
            i am a ux researcher and currently a phd student at smu hai-lab<sup style="cursor: pointer;" onclick="this.textContent = this.textContent === '*' ? 'SMU' : '*'">*</sup> advised by <a href="https://jchrisli.github.io/">Li Jiannan</a>
        </p>
        <p class="mobile-hello-text" style="font-size: 1rem; font-weight: 500;">
            working on <mark>human-agent interaction</mark> and <mark>creativity-centric research</mark>. 
        </p>
        <p class="mobile-hello-text" style="font-size: 1rem; font-weight: 500;">

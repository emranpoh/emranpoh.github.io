...
<section class="w-full">
    <div class="h-64 mb-4 introduction">
        ...
        <p class="mobile-hello-text" style="font-size: 1rem; font-weight: 500;">
            i am a ux researcher and currently a phd student at smu hai-lab<sup style="cursor: pointer;" onclick="this.textContent = this.textContent === '*' ? 'SMU' : '*'">*</sup> under <a href="https://jchrisli.github.io/">Li Jiannan</a>
        </p>
        <p class="mobile-hello-text" style="font-size: 1rem; font-weight: 500;">
